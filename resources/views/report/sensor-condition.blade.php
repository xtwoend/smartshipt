  ...
  <body>
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
          ...
          <tr class="row1">
            <td class="column1 style11 s style11" colspan="3">DAILY SENSOR CONDITION REPORT</td>
          </tr>
          <tr class="row2">
          ...
          <tr class="row30">
            ...
            <td class="column4 style31 null" style="{{ $sensor->condition == 'ABNORMAL' ? 'color:#ab0f0f;' : '' }} text-align: center;">{{ $sensor->condition ?? 'N/A' }}</td>
          </tr>
          @endforeach
        </tbody>
    </table>
