  ...
  <body>
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
          ...
          <tr class="row1">
            <td class="column1 style11 s style11" colspan="3">DAILY ALARM REPORT</td>
          </tr>
          <tr class="row2">
          ...
          <tr class="row20">
            ...
            <td class="column1 style22 null style24" colspan="3">{{ $avgSpeed ?? 0 }}</td>
          ...
          <tr class="row30">
            ...
            <td class="column1 style29 null style30" colspan="2" style="{{ $alarm->status ? 'color:#ab0f0f;' : '' }}">{{ $alarm->message }}</td>
