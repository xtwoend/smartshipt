        ...
        <div class="side-content">
            ...
            <div class="nav-button d-flex justify-content-between py-2">
                <form method="GET" class="d-flex justify-content-start">
                    <a href="{{ route('overview.index', ['type' => 'last-week']) }}" class="btn btn-default me-2">Last week</a>
                    <a href="{{ route('overview.index', ['type' => 'last-month']) }}" class="btn btn-default me-2">Last Month</a>
            ...
            <table class="table table-sm table-dark" id="report-xls">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-end">{{ number($f->mileage) }} NM</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
