...
<div class="col-12">
    <div class="row">
        ...
        <div class="col-6">
            @php
                $mimic = $fleet->mimic()->where('group', 'generator')->first();
            @endphp
            <fleet-svg-upload path="{{ $mimic?->path }}" group="generator" fleet-id="{{ $fleet->id }}"></fleet-svg-upload>
        </div>
    </div>
</div>
