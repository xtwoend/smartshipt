<div class="col-12">
    <div class="row">
        ...
        <div class="col-6">
            @php
                $mimic = $fleet->mimic()->where('group', 'cargo')->first();
            @endphp
            <fleet-svg-upload path="{{ $mimic?->path }}" group="cargo" fleet-id="{{ $fleet->id }}"></fleet-svg-upload>
        </div>
    </div>
</div>
...
<table-editable
    ...
    :fleet="{fleetId: {{ $fleet->id }}, group: 'cargo', ordered: 5 }"
