                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <table class="table text-sm">
                            <tbody>
                                ...
                                <tr>
                                    <td>Status</td>
                                    <td>{{ fleet.connected? 'Connected': 'Disconnect' }}</td>
                                </tr>
                                <tr>
                                    <td>Last Update</td>
                                    <td>{{ $filters.dateformat(fleet.last_connection) }} WIB</td>
                                </tr>
                                <tr>
                                    <td>Fuel Oil Temp</td>
                                    <td></td>
                                ...
                                <tr>
                                    <td>Exhaust Gas Turbo Charge inlet</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>Jacket Cooling Temp</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>Lube Oil temp</td>
                                ...
                                <tr>
                                    <td>Scaving Air Temp</td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td>Scaving Air Pressure</td>
                                    <td></td>
                                </tr>
                            </tbody>
                        </table>
