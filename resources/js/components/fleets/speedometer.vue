<template>
    <div class="row">
        <div class="col-3">
            <speedo-meter :value="fleet.navigation.sog" :max="32" title="Speed (knot)"></speedo-meter>
        </div>
        <div class="col-3">
            <compass :value="fleet.navigation.cog" title="Course (&deg;)"></compass>
        </div>
        <div class="col-3">
            <speedo-meter :value="fleet.navigation.wind_speed" :max="80"
                :title="scaleBeafort(fleet.navigation.wind_speed)"></speedo-meter>
        </div>
        <div class="col-3">
            <compass :value="fleet.navigation.wind_direction" title="Wind Direction"></compass>
        </div>
    </div>
</template>
