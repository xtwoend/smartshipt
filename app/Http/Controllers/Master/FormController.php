...
class FormController extends Controller
{
    ...
    public function meUpload(Request $request)
    {
        ...
        $data = [
            ...
            'speed' => $raw[11][2] ?: 0,
            'propeller_speed' => $raw[11][6] ?: 0,
            'me_rpm' => $raw[14][3] ?: 0,
            'me_running_hours' => $raw[15][3] ?: 0,
            'me_ht_water_cooling' => $raw[16][3] ?: 0,
            'me_lt_water_cooling' => $raw[17][3] ?: 0,
            'me_sea_water_cooling' => $raw[18][3] ?: 0,
            'me_engine_load' => $raw[19][3] ?: 0,
            'me_pressure_lo_inlet_tc' => $raw[20][3] ?: 0,
            'me_temp_lo_outlet_tc' => $raw[21][3] ?: 0,
            'me_pressure_lo_inlet_engine' => $raw[22][3] ?: 0,
            'me_temp_lo_inlet_engine' => $raw[23][3] ?: 0,
            'me_starting_air_engine_inlet' => $raw[24][3] ?: 0,
            'me_pressure_fo_engine_inlet' => $raw[25][3] ?: 0,
            'me_fo_engine_inlet_temp' => $raw[26][3] ?: 0,
            'tc_turbo_blower_speed' => $raw[14][11] ?: 0,
            'tc_blower_filter_pressure' => $raw[15][11] ?: 0,
            'tc_air_cooler_back_pressure' => $raw[16][11] ?: 0,
            'tc_scavenge_manifold_pressure' => $raw[17][11] ?: 0,
            'tc_exh_gas_pressure_aft_tc' => $raw[18][11] ?: 0,
            'temp_scaving_air_inlet_cooler' => $raw[20][11] ?: 0,
            'temp_scaving_air_outlet_cooler' => $raw[21][11] ?: 0,
            'temp_exh_gas_turbin_inlet' => $raw[22][11] ?: 0,
            'temp_exh_gas_turbin_outlet' => $raw[23][11] ?: 0,
            'temp_fo_specific_grafity' => $raw[25][11] ?: 0,
            'temp_fo_viscosity_118' => $raw[26][11] ?: 0,
            'gb_operating_pressure' => $raw[28][11] ?: 0,
            'gb_shaftbrake_pressure' => $raw[29][11] ?: 0,
            'gb_temp_after_oil_cooler' => $raw[30][11] ?: 0,
            'gb_temp_thrust_bearing' => $raw[31][11] ?: 0,
            'cr_fuel_command' => $raw[28][3] ?: 0,
            'cr_injection_time' => $raw[29][3] ?: 0,
            'cr_qty_piston_return' => $raw[30][3] ?: 0,
            'cr_exh_valve_oc_angel' => $raw[31][3] ?: 0,
            'cr_exh_valve_oc_dead_t' => $raw[33][3] ?: 0,
            'cr_servo_oil_pressure_sp' => $raw[33][3] ?: 0,
            'cr_fuel_rail_pressure_act' => $raw[34][3] ?: 0,
            'cr_vit' => $raw[35][3] ?: 0,
            // silinder
            'cyl_pressure_max_c1' => $raw[37][4] ?: 0,
            'cyl_pressure_max_c2' => $raw[37][5] ?: 0,
            'cyl_pressure_max_c3' => $raw[37][6] ?: 0,
            'cyl_pressure_max_c4' => $raw[37][7] ?: 0,
            'cyl_pressure_max_c5' => $raw[37][8] ?: 0,
            'cyl_pressure_max_c6' => $raw[37][9] ?: 0,
            'cyl_pressure_max_c7' => $raw[37][10] ?: 0,
            'cyl_pressure_max_c8' => $raw[37][11] ?: 0,

            'cyl_fuel_pump_index_c1' => $raw[38][4] ?: 0,
            'cyl_fuel_pump_index_c2' => $raw[38][5] ?: 0,
            'cyl_fuel_pump_index_c3' => $raw[38][6] ?: 0,
            'cyl_fuel_pump_index_c4' => $raw[38][7] ?: 0,
            'cyl_fuel_pump_index_c5' => $raw[38][8] ?: 0,
            'cyl_fuel_pump_index_c6' => $raw[38][9] ?: 0,
            'cyl_fuel_pump_index_c7' => $raw[38][10] ?: 0,
            'cyl_fuel_pump_index_c8' => $raw[38][11] ?: 0,

            'cyl_temp_exh_c1' => $raw[39][4] ?: 0,
            'cyl_temp_exh_c2' => $raw[39][5] ?: 0,
            'cyl_temp_exh_c3' => $raw[39][6] ?: 0,
            'cyl_temp_exh_c4' => $raw[39][7] ?: 0,
            'cyl_temp_exh_c5' => $raw[39][8] ?: 0,
            'cyl_temp_exh_c6' => $raw[39][9] ?: 0,
            'cyl_temp_exh_c7' => $raw[39][10] ?: 0,
            'cyl_temp_exh_c8' => $raw[39][11] ?: 0,

            'cyl_temp_jacket_fw_out_c1' => $raw[40][4] ?: 0,
            'cyl_temp_jacket_fw_out_c2' => $raw[40][5] ?: 0,
            'cyl_temp_jacket_fw_out_c3' => $raw[40][6] ?: 0,
            'cyl_temp_jacket_fw_out_c4' => $raw[40][7] ?: 0,
            'cyl_temp_jacket_fw_out_c5' => $raw[40][8] ?: 0,
            'cyl_temp_jacket_fw_out_c6' => $raw[40][9] ?: 0,
            'cyl_temp_jacket_fw_out_c7' => $raw[40][10] ?: 0,
            'cyl_temp_jacket_fw_out_c8' => $raw[40][11] ?: 0,

            'cyl_temp_crankcase_c1' => $raw[41][4] ?: 0,
            'cyl_temp_crankcase_c2' => $raw[41][5] ?: 0,
            'cyl_temp_crankcase_c3' => $raw[41][6] ?: 0,
            'cyl_temp_crankcase_c4' => $raw[41][7] ?: 0,
            'cyl_temp_crankcase_c5' => $raw[41][8] ?: 0,
            'cyl_temp_crankcase_c6' => $raw[41][9] ?: 0,
            'cyl_temp_crankcase_c7' => $raw[41][10] ?: 0,
            'cyl_temp_crankcase_c8' => $raw[41][11] ?: 0,

            'fo_comsumtion' => $raw[43][7] ?: 0,
            'fo_grade' => $raw[44][5] ?: null,
            'lubricant_lo_system' => $raw[44][7] ?: 0,
            'lubricant_lo_system_grade' => $raw[44][5] ?: null,
            'lubricant_gearbox' => $raw[45][7] ?: 0,
