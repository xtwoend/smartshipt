...
class FormController extends Controller
{
    ...
    public function meUpload(Request $request)
    {
        ...
        $data = [
            ...
            'from_port' => $raw[5][5] ?: 0,
            'to_port' => $raw[5][8] ?: 0,
            'engine_output' => $raw[7][7] ?: 0,
            'cyl_bore' => $raw[7][10] ?: 0,
            'mep' => $raw[8][7] ?: 0,
            'engine_rpm' => $raw[8][5] ?: 0,
            'piston_stroke' => $raw[8][10] ?: 0,
            'temp_engine_room' => $raw[9][2] ?: 0,
            'speed' => $raw[11][2] ?: 0,
            'propeller_speed' => (float) $raw[11][6] ?: 0,
            
            'me_rpm' => (float) $raw[14][3] ?: 0,
            'me_running_hours' => (float) $raw[15][3] ?: 0,
            'me_ht_water_cooling' => (float) $raw[16][3] ?: 0,
            'me_lt_water_cooling' => (float) $raw[17][3] ?: 0,
            'me_sea_water_cooling' => (float) $raw[18][3] ?: 0,
            'me_engine_load' => (float) $raw[19][3] ?: 0,
            'me_pressure_lo_inlet_tc' => (float) $raw[20][3] ?: 0,
            'me_temp_lo_outlet_tc' => (float) $raw[21][3] ?: 0,
            'me_pressure_lo_inlet_engine' => (float) $raw[22][3] ?: 0,
            'me_temp_lo_inlet_engine' => (float) $raw[23][3] ?: 0,
            'me_starting_air_engine_inlet' => (float) $raw[24][3] ?: 0,
            'me_pressure_fo_engine_inlet' => (float) $raw[25][3] ?: 0,
            'me_fo_engine_inlet_temp' => (float) $raw[26][3] ?: 0,
            'tc_turbo_blower_speed' => (float) $raw[14][11] ?: 0,
            'tc_blower_filter_pressure' => (float) $raw[15][11] ?: 0,
            'tc_air_cooler_back_pressure' => (float) $raw[16][11] ?: 0,
            'tc_scavenge_manifold_pressure' => (float) $raw[17][11] ?: 0,
            'tc_exh_gas_pressure_aft_tc' => (float) $raw[18][11] ?: 0,
            'temp_scaving_air_inlet_cooler' => (float) $raw[20][11] ?: 0,
            'temp_scaving_air_outlet_cooler' => (float) $raw[21][11] ?: 0,
            'temp_exh_gas_turbin_inlet' => (float) $raw[22][11] ?: 0,
            'temp_exh_gas_turbin_outlet' => (float) $raw[23][11] ?: 0,
            'temp_fo_specific_grafity' => (float) $raw[25][11] ?: 0,
            'temp_fo_viscosity_118' => (float) $raw[26][11] ?: 0,
            'gb_operating_pressure' => (float) $raw[28][11] ?: 0,
            'gb_shaftbrake_pressure' => (float) $raw[29][11] ?: 0,
            'gb_temp_after_oil_cooler' => (float) $raw[30][11] ?: 0,
            'gb_temp_thrust_bearing' => (float) $raw[31][11] ?: 0,
            'cr_fuel_command' => (float) $raw[28][3] ?: 0,
            'cr_injection_time' => (float) $raw[29][3] ?: 0,
            'cr_qty_piston_return' => (float) $raw[30][3] ?: 0,
            'cr_exh_valve_oc_angel' => (float) $raw[31][3] ?: 0,
            'cr_exh_valve_oc_dead_t' => (float) $raw[33][3] ?: 0,
            'cr_servo_oil_pressure_sp' => (float) $raw[33][3] ?: 0,
            'cr_fuel_rail_pressure_act' => (float) $raw[34][3] ?: 0,
            'cr_vit' => (float) $raw[35][3] ?: 0,
            // silinder
            'cyl_pressure_max_c1' => (float) $raw[37][4] ?: 0,
            'cyl_pressure_max_c2' => (float) $raw[37][5] ?: 0,
            'cyl_pressure_max_c3' => (float) $raw[37][6] ?: 0,
            'cyl_pressure_max_c4' => (float) $raw[37][7] ?: 0,
            'cyl_pressure_max_c5' => (float) $raw[37][8] ?: 0,
            'cyl_pressure_max_c6' => (float) $raw[37][9] ?: 0,
            'cyl_pressure_max_c7' => (float) $raw[37][10] ?: 0,
            'cyl_pressure_max_c8' => (float) $raw[37][11] ?: 0,

            'cyl_fuel_pump_index_c1' => (float) $raw[38][4] ?: 0,
            'cyl_fuel_pump_index_c2' => (float) $raw[38][5] ?: 0,
            'cyl_fuel_pump_index_c3' => (float) $raw[38][6] ?: 0,
            'cyl_fuel_pump_index_c4' => (float) $raw[38][7] ?: 0,
            'cyl_fuel_pump_index_c5' => (float) $raw[38][8] ?: 0,
            'cyl_fuel_pump_index_c6' => (float) $raw[38][9] ?: 0,
            'cyl_fuel_pump_index_c7' => (float) $raw[38][10] ?: 0,
            'cyl_fuel_pump_index_c8' => (float) $raw[38][11] ?: 0,

            'cyl_temp_exh_c1' => (float) $raw[39][4] ?: 0,
            'cyl_temp_exh_c2' => (float) $raw[39][5] ?: 0,
            'cyl_temp_exh_c3' => (float) $raw[39][6] ?: 0,
            'cyl_temp_exh_c4' => (float) $raw[39][7] ?: 0,
            'cyl_temp_exh_c5' => (float) $raw[39][8] ?: 0,
            'cyl_temp_exh_c6' => (float) $raw[39][9] ?: 0,
            'cyl_temp_exh_c7' => (float) $raw[39][10] ?: 0,
            'cyl_temp_exh_c8' => (float) $raw[39][11] ?: 0,

            'cyl_temp_jacket_fw_out_c1' => (float) $raw[40][4] ?: 0,
            'cyl_temp_jacket_fw_out_c2' => (float) $raw[40][5] ?: 0,
            'cyl_temp_jacket_fw_out_c3' => (float) $raw[40][6] ?: 0,
            'cyl_temp_jacket_fw_out_c4' => (float) $raw[40][7] ?: 0,
            'cyl_temp_jacket_fw_out_c5' => (float) $raw[40][8] ?: 0,
            'cyl_temp_jacket_fw_out_c6' => (float) $raw[40][9] ?: 0,
            'cyl_temp_jacket_fw_out_c7' => (float) $raw[40][10] ?: 0,
            'cyl_temp_jacket_fw_out_c8' => (float) $raw[40][11] ?: 0,

            'cyl_temp_crankcase_c1' => (float) $raw[41][4] ?: 0,
            'cyl_temp_crankcase_c2' => (float) $raw[41][5] ?: 0,
            'cyl_temp_crankcase_c3' => (float) $raw[41][6] ?: 0,
            'cyl_temp_crankcase_c4' => (float) $raw[41][7] ?: 0,
            'cyl_temp_crankcase_c5' => (float) $raw[41][8] ?: 0,
            'cyl_temp_crankcase_c6' => (float) $raw[41][9] ?: 0,
            'cyl_temp_crankcase_c7' => (float) $raw[41][10] ?: 0,
            'cyl_temp_crankcase_c8' => (float) $raw[41][11] ?: 0,

            'fo_comsumtion' => (float) $raw[43][7] ?: 0,
            'fo_grade' => $raw[44][5] ?: null,
            'lubricant_lo_system' => (float) $raw[44][7] ?: 0,
            'lubricant_lo_system_grade' => $raw[44][5] ?: null,
            'lubricant_gearbox' => (float) $raw[45][7] ?: 0,
            'lubricant_gearbox_grade' => $raw[45][5] ?: null,
        ];
    ...
    protected function label() {
        return (array) [
            ...
            'cyl_pressure_max_c8' => 'Tekanan PMax. Silinder 8',
            ...
            'cyl_fuel_pump_index_c8' => 'Indeks Pompa Bahan Bakar Silinder 8',
            ...
            'cyl_temp_exh_c8' => 'Suhu Gas buang Silinder 8',
            ...
            'cyl_temp_jacket_fw_out_c8' => 'Suhu Jacket FW Out Silinder 8',
            ...
            'cyl_temp_crankcase_c8' => 'Suhu Crankcase Silinder 8',
