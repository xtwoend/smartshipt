...
Route::group([
    ...
    Route::get('/{id}/navigation/latest', [\App\Http\Controllers\Api\V2\NavigationController::class, 'current']);
    ...
    Route::get('/{id}/engine/latest', [\App\Http\Controllers\Api\V2\EngineController::class, 'current']);
});